...
<p align="center">
  <a href="https://github.com/riadshrn/m2_enedis_dpe_app/raw/main/academic_report/DOCUMENTATION_FONCTIONNELLE.pdf" target="_blank" 
     style="
        display: inline-block;
        padding: 12px 25px;
        background: linear-gradient(135deg, #0066CC 0%, #33CC33 100%);
        color: white;
        font-weight: bold;
     ...
     Télécharger le rapport fonctionnel (PDF)
  </a>
</p>
