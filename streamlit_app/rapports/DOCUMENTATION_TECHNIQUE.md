# Documentation Technique — Application DPE Vision IA

## Objectif

L’application **DPE Vision IA** permet d’analyser et de prédire la **performance énergétique (étiquette DPE)** et la **consommation annuelle** des logements du département du Rhône à partir des données publiques **ADEME** et **Enedis**.
